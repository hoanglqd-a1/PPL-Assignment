...
class VMSuite(unittest.TestCase):
    ...
    #     input = """[
    #     [var(a, integer)],
    #     [proc(foo,[],[assign(a, add(a, 1)), call(writeIntLn, [a])])],
    #     [assign(a, 0), 
    #     block(
    #         [var(a, integer)], 
    #         [assign(a, 10), call(foo, [])]
    #     ),
    #     call(foo, [])]]."""
    #     expect = "11\n1\n"
    ...
    #         call(writeIntLn, [2])
    #     )]]."""
    #     expect = "Type mismatch: if(add(1,2),call(writeIntLn,[1]),call(writeIntLn,[2]))"
    ...
    def test_funccall6(self):
        input = """[
        [],
        [func(foo, [], integer, [assign(foo, 1), assign(foo, 2)])],
    ...
    def test_funccall7(self):
        input = """[
        [],
        [func(foo, [par(a, boolean)], integer, [if(a, assign(foo,1))])],
        [call(writeIntLn, [call(foo, [true])]), call(writeIntLn, [call(foo, [false])])]]."""
        expect = "1\nInvalid expression: call(foo,[false])"
